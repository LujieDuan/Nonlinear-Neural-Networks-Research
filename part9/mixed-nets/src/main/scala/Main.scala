...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    new LinearNonlinearMixed(LEARNING_RATE, layer_structures, EPOCH, MINI_BATCH_SIZE).start()
    new NonlinearLinearMixed(LEARNING_RATE, layer_structures, EPOCH, MINI_BATCH_SIZE).start()
  }
