...
object Common {
  ...
  def outputResults(dataset: SetsType, costs: CostsType, startTime: Long)(implicit fileName: String): Unit = {
    ...
    log(s"Final costs on train-dataset: ${costs._1.last._2 / dataset._1.length} validation-dataset: ${costs._2.last._2 / dataset._2.length} " +
      s"testSet-dataset: ${costs._3.last._2 / dataset._3.length}")
